...
3. **Override configs:**
```bash
CUDA_VISIBLE_DEVICES=1,2,3,4,5,6,7,8,9 python run_peaknet_streaming_pipeline.py experiment=peaknet_test_run streaming.runtime.max_actors=9 streaming.runtime.total_samples=20480
```
